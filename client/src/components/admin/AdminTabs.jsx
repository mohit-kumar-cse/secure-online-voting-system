      ...
      <div className="flex gap-1 bg-gray-100 p-1 rounded-xl w-fit min-w-full sm:min-w-0">
        {tabs.map((t) => (
          <button
            ...
            className={`flex items-center gap-1.5 text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-lg font-medium transition whitespace-nowrap
              ${active === t.id
          ...
          >
            ...
            <span className={active === t.id ? "text-blue-600" : "text-gray-400"}>
              {t.icon}
            </span>
            {t.label}
          </button>
